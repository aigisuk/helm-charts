    ...
    spec:
      ...
      - image: "{{ .Values.image.name }}:{{ default .Chart.AppVersion .Values.image.tag }}"
        ...
        args:
          ...
          {{- end }}
          {{- if .Values.metrics.influxdb2 }}
          - "--metrics.influxdb2=true"
          - "--metrics.influxdb2.address={{ .Values.metrics.influxdb2.address }}"
          - "--metrics.influxdb2.token={{ .Values.metrics.influxdb2.token }}"
          - "--metrics.influxdb2.org={{ .Values.metrics.influxdb2.org }}"
          - "--metrics.influxdb2.bucket={{ .Values.metrics.influxdb2.bucket }}"
          {{- end }}
          {{- if .Values.metrics.prometheus }}
